...
--
-- This file is the human-reviewable schema reference. The runnable
-- migrations in apps/api/migrations/ are generated from it and must stay
-- in sync. No borrower production data is ever loaded by this schema or
-- its seeds.
--
-- Conventions:
